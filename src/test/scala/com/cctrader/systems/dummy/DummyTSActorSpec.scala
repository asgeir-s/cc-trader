...
class DummyTSActorSpec extends UnitTest {
  ...
  val dummyTSActorRef = TestActorRef(new DummyTSActor(marketDataSet, new Signaler("DummyTest", 99), Settings2Props.loadTsSetting("tsSettings/test/DummyTest1.conf")))
